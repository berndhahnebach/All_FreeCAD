/****************************************************************************
** Form implementation generated from reading ui file '.\DlgPartImportStep.ui'
**
** Created: Mi 17. Mai 14:44:48 2006
...
/*
 *  Constructs a PartGui::DlgPartImportStep as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
PartGui::DlgPartImportStep::DlgPartImportStep( QWidget* parent, const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    if ( !name )
	setName( "PartGui::DlgPartImportStep" );
    DlgPartImportStepLayout = new QVBoxLayout( this, 11, 6, "DlgPartImportStepLayout"); 
    ...
    DlgPartImportStepLayout->addWidget( GroupBox5 );
    ...
    Layout13->addItem( spacer, 0, 1 );
    DlgPartImportStepLayout->addLayout( Layout13 );
    languageChange();
 ...
 */
PartGui::DlgPartImportStep::~DlgPartImportStep()
{
 ...
 *  language.
 */
void PartGui::DlgPartImportStep::languageChange()
{
    setCaption( tr( "Step input file" ) );
...
void PartGui::DlgPartImportStep::OnApply()
{
    qWarning( "PartGui::DlgPartImportStep::OnApply(): Not implemented yet" );
}

void PartGui::DlgPartImportStep::onChooseFileName()
{
    qWarning( "PartGui::DlgPartImportStep::onChooseFileName(): Not implemented yet" );
}

...
#
# Created: Wed Jan 26 18:41:50 2011
...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        self.spinBox_misalignment_x_from.setObjectName("spinBox_misalignment_x_from")
        ...
        self.spinBox_misalignment_x_to.setObjectName("spinBox_misalignment_x_to")
        self.gridLayout.addWidget(self.spinBox_misalignment_x_to, 1, 1, 1, 1)
        self.spinBox_misalignment_x_intervall = QtGui.QDoubleSpinBox(self.groupBox_3)
        ...
        self.spinBox_misalignment_x_intervall.setDecimals(1)
        self.spinBox_misalignment_x_intervall.setMaximum(90.0)
        self.spinBox_misalignment_x_intervall.setProperty("value", 0.0)
        self.spinBox_misalignment_x_intervall.setObjectName("spinBox_misalignment_x_intervall")
        ...
        self.spinBox_misalignment_y_from.setObjectName("spinBox_misalignment_y_from")
        ...
        self.spinBox_misalignment_y_to.setObjectName("spinBox_misalignment_y_to")
        self.gridLayout.addWidget(self.spinBox_misalignment_y_to, 2, 1, 1, 1)
        self.spinBox_misalignment_y_intervall = QtGui.QDoubleSpinBox(self.groupBox_3)
        ...
        self.spinBox_misalignment_y_intervall.setDecimals(1)
        self.spinBox_misalignment_y_intervall.setMaximum(90.0)
        self.spinBox_misalignment_y_intervall.setObjectName("spinBox_misalignment_y_intervall")
        ...
        self.spinBox_misalignment_z_from.setObjectName("spinBox_misalignment_z_from")
        ...
        self.spinBox_misalignment_z_to.setObjectName("spinBox_misalignment_z_to")
        self.gridLayout.addWidget(self.spinBox_misalignment_z_to, 3, 1, 1, 1)
        self.spinBox_misalignment_z_intervall = QtGui.QDoubleSpinBox(self.groupBox_3)
        ...
        self.spinBox_misalignment_z_intervall.setDecimals(1)
        self.spinBox_misalignment_z_intervall.setMaximum(90.0)
        self.spinBox_misalignment_z_intervall.setObjectName("spinBox_misalignment_z_intervall")
        ...
        self.spinBox_z_level_intervall = QtGui.QDoubleSpinBox(self.groupBox_3)
        ...
        self.spinBox_z_level_intervall.setSingleStep(0.1)
        self.spinBox_z_level_intervall.setProperty("value", 0.1)
        self.spinBox_z_level_intervall.setObjectName("spinBox_z_level_intervall")
        ...
        self.select_L_file.setObjectName("select_L_file")
        ...
        self.select_LT_file.setObjectName("select_LT_file")
        ...
        self.gridLayout_8.addWidget(self.button_add_to_table, 2, 0, 1, 1)
        ...
        self.JobTable.setColumnCount(29)
        self.JobTable.setRowCount(0)
        self.gridLayout_9.addWidget(self.JobTable, 2, 0, 1, 3)
        ...
        self.gridLayout_9.addWidget(self.button_dialog, 3, 2, 1, 1)

        self.retranslateUi(dialog)
        QtCore.QMetaObject.connectSlotsByName(dialog)
        dialog.setTabOrder(self.button_select_file, self.button_select_output)
        dialog.setTabOrder(self.button_select_output, self.spinBox_misalignment_x_from)
    ...
    def retranslateUi(self, dialog):
        ...
        self.label_23.setText(QtGui.QApplication.translate("dialog", "Solver", None, QtGui.QApplication.UnicodeUTF8))
        self.lineEdit.setText(QtGui.QApplication.translate("dialog", "/home/rmjzettl/calculix/CCX_2_2_COMPILATION/Calculix/ccx_2.2/src/ccx_2.2_MT", None, QtGui.QApplication.UnicodeUTF8))

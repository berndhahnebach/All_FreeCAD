...
def process(doc,filename):    
  ...
  for lin in afile:
	...
	# The swap
        upside=False        
        # Not needed because this will happen anyhow at the end of the loop
        #last_x=x 
  ...
  #makeWire has currently some problems see Bug #3100139
  #face = makeWire ( upper, True, None, True )   
    
  # alternate solution as a temporary workaround
  lines = []
  first_v = None
  last_v = None
  for v in upper:

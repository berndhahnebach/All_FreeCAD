...
#ifndef FEATURE_MESH_IMPORT_STL_H
#define FEATURE_MESH_IMPORT_STL_H
...
/**
 * The FeatureMeshImportSTL class reads the STL mesh format
 * into the FreeCAD workspace.
 * @author Werner Mayer
 */
class FeatureMeshImportSTL : public MeshFeature
{
public:
  ...
  virtual const char *Type(void){return "MeshImportSTL";};
};

}

#endif // FEATURE_MESH_IMPORT_STL_H 

...
# ADD LINK32 opengl32.lib glu32.lib /nologo /dll /machine:I386 /out:"Release/ImageGui.pyd" /libpath:"$(QTDIR)\lib"
...
# ADD LINK32 opengl32.lib glu32.lib /nologo /dll /debug /machine:I386 /out:"Debug/ImageGui_d.pyd" /pdbtype:sept /libpath:"$(QTDIR)\lib"
# Begin Special Build Tool
SOURCE="$(InputPath)"

...
def CreateSlotPlateSet(SketchFeature):
	...
	SketchFeature.setDatum(200.000000,9)
	SketchFeature.addConstraint(Sketcher.Constraint('Radius',3,38.424808)) 
	SketchFeature.setDatum(40.000000,10)
	SketchFeature.setDatum(0.872665,8)
	SketchFeature.addConstraint(Sketcher.Constraint('DistanceX',0,2,0.0)) 
	SketchFeature.setDatum(0.000000,11)
	...
	SketchFeature.setDatum(0.000000,12)

...
#define _BRepMeshAdapt_DataMapNodeOfDataMapOfShapeReal_HeaderFile
...
class BRepMeshAdapt_DataMapNodeOfDataMapOfShapeReal : public TCollection_MapNode {

public:
 // Methods PUBLIC
 // 

BRepMeshAdapt_DataMapNodeOfDataMapOfShapeReal(const TopoDS_Shape& K,const Standard_Real& I,const TCollection_MapNodePtr& n);

  TopoDS_Shape& Key() const;

  Standard_Real& Value() const;
//Standard_EXPORT ~BRepMeshAdapt_DataMapNodeOfDataMapOfShapeReal();

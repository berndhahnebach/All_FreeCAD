...
#define _BRepMeshAdapt_ComparatorOfIndexedVertexOfDelaun_HeaderFile
...
Standard_EXPORT BRepMeshAdapt_ComparatorOfIndexedVertexOfDelaun(const gp_XY& theDir,const Standard_Real TheTol,const Handle(BRepMeshAdapt_DataStructureOfDelaun)& HDS);
...
private: 
 ...
 // Fields PRIVATE
 //
Handle_BRepMeshAdapt_DataStructureOfDelaun IndexedStructure;

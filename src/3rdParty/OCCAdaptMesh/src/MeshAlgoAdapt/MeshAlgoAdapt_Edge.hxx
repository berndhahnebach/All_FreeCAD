...
#ifndef _MeshAlgoAdapt_Edge_HeaderFile
#define _MeshAlgoAdapt_Edge_HeaderFile
...
Standard_EXPORT   Standard_Boolean SameOrientation(const MeshAlgoAdapt_Edge& Other) const;


Standard_EXPORT   Standard_Integer HashCode(const Standard_Integer Upper) const;


Standard_EXPORT   Standard_Boolean IsEqual(const MeshAlgoAdapt_Edge& Other) const;
  Standard_Boolean operator ==(const MeshAlgoAdapt_Edge& Other) const
{
...
Standard_EXPORT MeshAlgoAdapt_Edge(const Standard_Integer node1,const Standard_Integer node2,const MeshDS_DegreeOfFreedom canMove,const Standard_Integer domain);
...
//
inline Standard_Integer HashCode(const MeshAlgoAdapt_Edge& me,const Standard_Integer Upper) {

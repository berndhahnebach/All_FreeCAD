...
#define FCRevisionDate  "2010/06/13 20:36:40"     //Date of highest committed revision
#define FCRevisionRange "3225"    //Update revision range
#define FCRepositoryURL "https://free-cad.svn.sourceforge.net/svnroot/free-cad/trunk"      //Repository URL of the working copy
#define FCCurrentDateT  "2010/06/13 23:10:10"      //Current system date & time

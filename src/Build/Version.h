...
#define FCRevision      "3494"      //Highest committed revision number
#define FCRevisionDate  "2010/08/31 19:12:03"     //Date of highest committed revision
#define FCRevisionRange "3494"    //Update revision range
#define FCRepositoryURL "https://free-cad.svn.sourceforge.net/svnroot/free-cad/trunk"      //Repository URL of the working copy
#define FCCurrentDateT  "2010/08/31 23:34:44"      //Current system date & time

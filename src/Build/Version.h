...
#define FCRevision      "1342"      //Highest committed revision number
#define FCRevisionDate  "2008/05/19 11:25:16"     //Date of highest committed revision
#define FCRevisionRange "1342"    //Update revision range
#define FCRepositoryURL "https://free-cad.svn.sourceforge.net/svnroot/free-cad/trunk"      //Repository URL of the working copy
#define FCCurrentDateT  "2008/05/19 23:39:47"      //Current system date & time

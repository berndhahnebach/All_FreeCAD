...
#define FCRevision      "3142"      //Highest committed revision number
#define FCRevisionDate  "2010/04/30 12:42:23"     //Date of highest committed revision
#define FCRevisionRange "3142"    //Update revision range
#define FCRepositoryURL "https://free-cad.svn.sourceforge.net/svnroot/free-cad/trunk"      //Repository URL of the working copy
#define FCCurrentDateT  "2010/04/30 18:38:50"      //Current system date & time

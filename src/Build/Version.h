...
#define FCRevision      "3052"      //Highest committed revision number
#define FCRevisionDate  "2010/03/21 19:39:56"     //Date of highest committed revision
#define FCRevisionRange "3052"    //Update revision range
#define FCRepositoryURL "https://free-cad.svn.sourceforge.net/svnroot/free-cad/trunk"      //Repository URL of the working copy
#define FCCurrentDateT  "2010/03/21 19:59:27"      //Current system date & time

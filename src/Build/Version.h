...
#define FCRevision      "2860"      //Highest committed revision number
#define FCRevisionDate  "2010/01/16 11:39:40"     //Date of highest committed revision
#define FCRevisionRange "2860"    //Update revision range
#define FCRepositoryURL "https://free-cad.svn.sourceforge.net/svnroot/free-cad/trunk"      //Repository URL of the working copy
#define FCCurrentDateT  "2010/01/16 16:20:33"      //Current system date & time

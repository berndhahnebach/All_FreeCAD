...
# ADD CPP /nologo /G6 /MD /W3 /GR /GX /O2 /D "NDEBUG" /D "_CONSOLE" /FD /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /subsystem:console /pdb:"../../lib/FreeCADCmd.pdb" /machine:I386 /out:"ReleaseCmd\FreeCADCmd.exe"
...
# ADD CPP /nologo /G6 /MDd /W3 /Gm /GR /GX /ZI /Od /D "_CONSOLE" /D "FC_DEBUG" /FD /GZ /c
# SUBTRACT CPP /Fr /YX
...
# ADD LINK32 /nologo /subsystem:console /debug /machine:I386 /out:"DebugCmd\FreeCADCmdD.exe" /pdbtype:sept
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
SOURCE="$(InputPath)"

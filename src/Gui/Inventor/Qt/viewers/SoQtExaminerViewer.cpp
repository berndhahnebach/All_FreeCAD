...
/*!
  ...
  \brief The SoQtExaminerViewer class is a 3D-model examination viewer.
  ...
  SoQtExaminerViewer as a model viewer that loads Inventor and VRML
  ...
  SoQtExaminerViewer has a convenient interface for repositioning
  ...
  The SoQtExaminerViewer provides a user decoration's button for
  ...
  \sa SoQtFlyViewer, SoQtPlaneViewer
*/
...
SbBool
SoQtExaminerViewer::isAnimationEnabled(void) const
{
...
SbBool
SoQtExaminerViewer::isAnimating(void) const
{
...
void
SoQtExaminerViewer::setFeedbackVisibility(const SbBool enable)
{
...
*/
void
SoQtExaminerViewer::setCursorEnabled(SbBool enable)
{
...
#if SOQT_DEBUG
    SoDebugError::postWarning("SoQtExaminerViewer::setViewing",
...
SoGuiExaminerViewerP::SoGuiExaminerViewerP(SoQtExaminerViewer * publ)
{
  PUBLIC(this) = publ;
}
...
SoGuiExaminerViewerP::setCursorRepresentation(int mode)
{
  ...
  case SoGuiExaminerViewerP::ZOOMING:
    PUBLIC(this)->setComponentCursor(SoQtCursor::getZoomCursor());
    break;

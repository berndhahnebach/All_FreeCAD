...
def InitMenues():
	...
	list = ["Std_ViewCreateInventor","Separator","Std_ToggleVisibility","Std_ViewFullScreen","Std_PerspectiveCamera","Std_OrthographicCamera","Separator", "Std_ViewMenu", "Std_ViewStatusBar"]

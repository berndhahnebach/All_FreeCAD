...
//		kdDebug() << "KexiProperty::KexiProperty(): labeled property (" << m_desc << ")" << endl;
	...
	switch(value.type())
	{
		case QVariant::Size:
		{
			...
			addChild( new KexiProperty("width", QVariant(s.width()), FCTools::i18n("width")) );
			addChild( new KexiProperty("height", QVariant(s.height()), FCTools::i18n("height")) );
			break;
		}
		case QVariant::Point:
		{
			QPoint p = value.toPoint();
			addChild( new KexiProperty("x", p.x(), FCTools::i18n("x")) );
			addChild( new KexiProperty("y", p.y(), FCTools::i18n("y")) );
			break;
		}
		case QVariant::Rect:
		{
			QRect r = value.toRect();
			addChild( new KexiProperty("x", r.x(), FCTools::i18n("x")) );
			addChild( new KexiProperty("y", r.y(), FCTools::i18n("y")) );
			addChild( new KexiProperty("width", r.width(), FCTools::i18n("width")) );
			addChild( new KexiProperty("height", r.height(), FCTools::i18n("height")) );
			break;
		}
		case QVariant::SizePolicy:
		{
			...
			addChild( new KexiProperty("hStretch", (int)p.horStretch(), FCTools::i18n("hStretch") ) );
			addChild( new KexiProperty("vStretch", (int)p.verStretch(), FCTools::i18n("vStretch") ) );
			break;
		}
		default:
		{

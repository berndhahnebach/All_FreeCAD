...
# ADD CPP /nologo /G6 /MD /W3 /GR /GX /O2 /I "." /I "inventor/Qt" /I ".." /D "NDEBUG" /D "_USRDLL" /D "FCGui" /D "SCI_LEXER" /Yu"PreCompiled.h" /FD /c
# SUBTRACT CPP /Fr
...
SOURCE="$(InputPath)"
PostBuild_Cmds=mkdir ..\..\bin	copy Release\FreeCADGui.dll ..\..\bin
...
# ADD CPP /nologo /G6 /MDd /W3 /Gm /GR /GX /ZI /Od /I "." /I "inventor/Qt" /I ".." /D "_USRDLL" /D "FCGui" /D "FC_DEBUG" /D "SCI_LEXER" /Yu"PreCompiled.h" /FD /GZ /c
# SUBTRACT CPP /Fr
...
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=mkdir ..\..\bin	copy Debug\FreeCADGuiD.dll ..\..\bin
# End Special Build Tool
...
SOURCE=.\View3DInventorEx.cpp
# End Source File
# Begin Source File

SOURCE=.\View3DInventorEx.h

!IF  "$(CFG)" == "FreeCADGui - Win32 Release"

# Begin Custom Build - Moc'ing $(InputName).h ...
InputDir=.
InputPath=.\View3DInventorEx.h
InputName=View3DInventorEx

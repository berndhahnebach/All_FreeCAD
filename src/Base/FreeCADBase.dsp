...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /D "NDEBUG" /D "_WINDOWS" /D "_USRDLL" /D "_PreComp_" /D "WIN32" /D "_MBCS" /D "WNT" /D "__STL_USE_DECLSPEC" /D "FCBase" /YX"PreCompiled.h" /FD /c
...
SOURCE="$(InputPath)"
PostBuild_Cmds=copy Release\FreeCADBase.dll ..\..\bin
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /D "_DEBUG" /D "__STL_DEBUG" /D "_WINDOWS" /D "_USRDLL" /D "_PreComp_" /D "WIN32" /D "_MBCS" /D "WNT" /D "__STL_USE_DECLSPEC" /D "FCBase" /FR /YX"PreCompiled.h" /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"Debug/FreeCADBaseD.dll" /pdbtype:sept
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=copy Debug\FreeCADBaseD.dll ..\..\bin
# End Special Build Tool
